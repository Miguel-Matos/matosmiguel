...
export default function Contact() {
  ...
  const sendEmail = (e:any) => {
    ...
    emailjs.sendForm(process.env.VITE_PUBLIC_SERVICE_ID as string, process.env.VITE_PUBLIC_TEMPLATE_ID as string, form.current, process.env.VITE_PUBLIC_KEY as string)
      .then((result) => {
