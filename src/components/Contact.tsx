...
export default function Contact() {
  ...
  const sendEmail = (e:any) => {
    ...
    emailjs.sendForm(process.env.NEXT_PUBLIC_SERVICE_ID as string, process.env.NEXT_PUBLIC_TEMPLATE_ID as string, form.current, process.env.NEXT_PUBLIC_KEY as string)
      .then((result) => {
